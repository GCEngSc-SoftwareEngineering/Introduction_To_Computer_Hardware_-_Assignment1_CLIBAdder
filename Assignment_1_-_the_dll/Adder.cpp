...
// public.
	...
	{
		double ans = (double)CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_get_Input_Subset_praise0_valueA() + (double)CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_get_Input_Subset_praise0_valueB();
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Output_Subset_praise0_value(ans);
		return CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_get_Output_Subset_praise0_value();
	}
	void CLIBAdder::Adder::dyn_initialise_Input_Subset_praise0_valueA(void* obj, float newINITIALISED_value)
	{
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Input_Subset_praise0_valueA(newINITIALISED_value);
	}
	void CLIBAdder::Adder::dyn_initialise_Input_Subset_praise0_valueB(void* obj, float newINITIALISED_value)
	{
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Input_Subset_praise0_valueB(newINITIALISED_value);
	}
	void CLIBAdder::Adder::dyn_initialise_Output_Subset_praise0_value(void* obj, double newINITIALISED_value)
	{
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Output_Subset_praise0_value(newINITIALISED_value);
	}
			// crate.
			// get.
	float CLIBAdder::Adder::dyn_REG_get_Input_Subset_praise0_valueA(void* obj)
	{
		return CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_get_Input_Subset_praise0_valueB();
	}
	...
	{
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Input_Subset_praise0_valueA(newValue);
	}
	void CLIBAdder::Adder::dyn_REG_set_Input_Subset_praise0_valueB(void* obj, float newValue)
	{
		CLIBAdder::Global::stat_obj_getClassOf(obj)->get_CLASS_Adder()->stat_REG_set_Input_Subset_praise0_valueB(newValue);
	}
// private.
	// static.
		// classes.
